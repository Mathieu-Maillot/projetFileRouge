...
const Icon = ({ type, size, action }) => {
	switch (type) {
		...
		case 'allow-smoke':
			return (
				<svg viewBox="0 0 512 512" onClick={action} width={size} cursor="pointer" height={size} xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill="var(--ci-primary-color, #000000)" d="M16,240V360H360V240H16Zm312,88H48V272H328Z" class="ci-primary"></path> <rect width="32" height="120" x="384" y="240" fill="var(--ci-primary-color, #000000)" class="ci-primary"></rect> <rect width="32" height="120" x="440" y="240" fill="var(--ci-primary-color, #000000)" class="ci-primary"></rect> <path fill="var(--ci-primary-color, #000000)" d="M385.428,173.3a31.982,31.982,0,0,1,2.32-38.418,63.745,63.745,0,0,0,3.479-78.69L385.377,48H348.8l-1.82,1.3,18.207,25.49a31.807,31.807,0,0,1-1.736,39.265,64.1,64.1,0,0,0-4.649,76.993L364.77,200h38.46Z" class="ci-primary"></path> <path fill="var(--ci-primary-color, #000000)" d="M457.428,173.3a31.982,31.982,0,0,1,2.32-38.418,63.745,63.745,0,0,0,3.479-78.69L457.377,48H420.8l-1.82,1.3,18.207,25.49a31.807,31.807,0,0,1-1.736,39.265,64.1,64.1,0,0,0-4.649,76.993L436.77,200h38.46Z" class="ci-primary"></path> </g></svg>
			);
		case 'non-smoke':
			return (
